...
def test_napari_windows_path_escaping():
    ...
    with patch('os.getcwd', return_value=windows_path):
        with patch('os.makedirs'):
            with patch('os.path.expanduser', return_value="C:\\Users\\labuser\\.local\\share\\openhcs\\logs"):
                with patch('subprocess.Popen') as mock_popen:
                    with patch('builtins.open', MagicMock()):
                        ...
                        python_code = call_args[0][0][2]  # [sys.executable, "-c", python_code]
                        ...
                        assert "C:\\\\Users" in python_code or "'C:\\\\Users" in python_code or '"C:\\\\Users' in python_code, \
...
def test_napari_unix_path_still_works():
    ...
    with patch('os.getcwd', return_value=unix_path):
        with patch('os.makedirs'):
            with patch('os.path.expanduser', return_value="/home/user/.local/share/openhcs/logs"):
                with patch('subprocess.Popen') as mock_popen:
                    with patch('builtins.open', MagicMock()):
                        # Call the function
                        napari_stream_visualizer._spawn_detached_napari_process(
