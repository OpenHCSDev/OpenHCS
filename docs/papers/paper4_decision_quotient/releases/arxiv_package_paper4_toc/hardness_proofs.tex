...
Within the formal model (Section~\ref{sec:foundations}) and the succinct encoding used for hardness (Section~\ref{sec:encoding}), these results sit beyond NP-completeness and provide a rigorous explanation for why over-modeling can be a rational strategy: in the worst case, finding (or even certifying) a minimal set of decision-relevant factors is computationally intractable.
