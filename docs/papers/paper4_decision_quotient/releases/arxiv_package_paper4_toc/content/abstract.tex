...
\item \textbf{Intermediate query-access lower bound:} In the mechanized Boolean query submodel, SUFFICIENCY-CHECK has worst-case query complexity $\Omega(2^n)$ via an oracle-indistinguishable pair for the $I=\emptyset$ subproblem.
\end{itemize}
