...
The reduction constructions and key equivalence theorems are machine-checked in Lean 4 ($\sim$5,000 lines, 200+ theorems); complexity classifications follow by composition with standard results (see Appendix~\ref{app:lean}).
