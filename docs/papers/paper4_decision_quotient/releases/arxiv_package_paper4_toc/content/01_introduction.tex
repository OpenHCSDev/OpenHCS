...
\item In the intermediate query-access model: the mechanized Boolean query submodel has an exponential obstruction scale in queried-coordinate size ($2^{|I|}-1$; Proposition~\ref{prop:query-regime-obstruction}).
...
The explicit ETH lower bound is still a succinct worst-case statement; Proposition~\ref{prop:query-regime-obstruction} partially fills the intermediate-regime gap by formalizing a query-access obstruction family.
