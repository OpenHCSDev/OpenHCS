...
\textit{(Lean finite-cardinality form: \nolinkurl{ClaimClosure.adq_ordering})}
\end{proposition}
...
\begin{proof}
Part (1) is Corollary~\ref{cor:right-wrong-hardness}. Part (2) is exactly \nolinkurl{HardnessDistribution.centralized_higher_leverage}. Part (3) is Theorem~\ref{thm:generalized-dominance}. Part (4) is Proposition~\ref{prop:generalized-assumption-boundary}.
\end{proof}
...
\nolinkurl{HardnessDistribution.generalized_dominance_can_fail_without_right_boundedness})}
\end{proposition}
