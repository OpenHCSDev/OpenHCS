...
\item \textbf{Intermediate query-access obstruction:} In the mechanized Boolean query submodel, the obstruction scale in queried-coordinate size is exponential ($2^{|I|}-1$).
\end{itemize}
