...
\paragraph{The verification gap.} Published complexity proofs occasionally contain errors~\cite{lipton2009np}. Machine verification eliminates this uncertainty. Our contribution demonstrates that complexity reductions are amenable to formalization with reasonable effort ($\sim$3,200 lines for five reduction proofs).
