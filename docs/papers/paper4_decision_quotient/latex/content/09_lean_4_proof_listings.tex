...
\item \textbf{Reduction correctness.} The TAUTOLOGY reduction (Section~\ref{sec:hardness}) is machine-checked to preserve the decision structure. Informal reductions can have subtle bugs; Lean verification guarantees the mapping is correct.
...
The formalization consists of 26 files organized as follows:
...
\begin{itemize}
\item Total lines: 3,600+
\item Theorems: $\sim$70
\item Files: 26
