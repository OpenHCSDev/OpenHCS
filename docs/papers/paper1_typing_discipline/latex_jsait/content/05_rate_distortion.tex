...
Assuming the attribute profile is not class-injective (i.e., collisions exist), nominal-tag observers achieve the unique Pareto-optimal point in the $(L, W, D)$ space with $D = 0$:
\begin{itemize}
...
Under the same assumption, interface-only observers achieve:
\begin{itemize}
