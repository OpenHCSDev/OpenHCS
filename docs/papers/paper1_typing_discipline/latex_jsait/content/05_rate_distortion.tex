...
\begin{theorem}[Pareto Optimality of Nominal-Tag Observers]
...
\item \textbf{Witness cost}: $W = O(n)$ primitive queries (must query $n$ interfaces)
...
\item \texttt{duck\_cost\_linear}: Interface-only requires $O(n)$ queries
