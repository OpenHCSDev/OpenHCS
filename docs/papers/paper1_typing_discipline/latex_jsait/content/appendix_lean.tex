...
\midrule
\texttt{abstract\_class\_system.lean} & 3082 & 90+ & Two-axis model, information barrier, dominance \\
\texttt{axis\_framework.lean} & 1667 & 40+ & Query families, closure, matroid structure \\
\texttt{nominal\_resolution.lean} & 556 & 21 & Nominal identification and witness procedures \\
...
\midrule
\textbf{Core modules subtotal} & \textbf{6100+} & \textbf{190+} & \textbf{9 representative modules shown} \\
\bottomrule
\end{tabular}
\end{table*}
...
\subsection{Interface-Only Formalization}\label{interface-only-formalization}
