...
This means: all observer strategies achieve the same compression ratio when using minimal complete axis sets. The difference between nominal-tag and interface-only observers lies in \emph{witness cost}, not compression efficiency.
