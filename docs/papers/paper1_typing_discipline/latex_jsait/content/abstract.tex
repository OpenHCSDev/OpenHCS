...
\textbf{Structure.} Minimal distinguishing query sets form the bases of a matroid. All such sets have equal cardinality; the ``distinguishing dimension'' of a classification problem is well-defined.
