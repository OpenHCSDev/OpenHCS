...
\textbf{Matroid structure.} Minimal sufficient query sets form the bases of a matroid. The \emph{identification dimension}---common cardinality of all minimal query sets---is well-defined and computable, connecting to zero-error source coding via graph entropy.
