...
\item \textbf{Minimal observation sets have matroid structure.} All minimal complete observation sets for a domain have equal cardinality. The ``semantic dimension'' of a classification problem is well-defined.
\end{enumerate}
