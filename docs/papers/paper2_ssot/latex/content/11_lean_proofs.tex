...
All theorems are machine-checked in Lean 4 (1,605 lines across 12 files, 0 \texttt{sorry} placeholders). Complete source available at: \texttt{proofs/ssot/}.
...
\midrule
\textbf{Total} & \textbf{1,605} & \textbf{79} \\
\bottomrule
\end{tabular}
\end{center}

\textbf{All 79 theorems compile without \texttt{sorry} placeholders.} The proofs can be verified by running \texttt{lake build} in the \texttt{proofs/ssot/} directory. Every theorem in the paper corresponds to a machine-checked proof.
