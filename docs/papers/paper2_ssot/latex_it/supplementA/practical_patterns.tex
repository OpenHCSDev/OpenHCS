\section{Practical Patterns and Case Study: Realizability Patterns}
\label{supp:practical}
%==============================================================================

We provide a concrete worked example from OpenHCS~\cite{openhcs2025}, a production bioimage analysis platform implemented in Python. This supplement supplies the full constructive instantiation of the realizability theorem: explicit mechanisms that satisfy the abstract requirements in a real system, full before/after code excerpts, measurement tables, and links to the public PRs and repository snapshots.
...
This pattern demonstrates why both SSOT requirements (definition-time hooks \emph{and} introspection) are necessary. The code is from \texttt{openhcs/debug/pickle_to_python.py}, which converts serialized Python objects to runnable Python scripts.
...
\begin{itemize}
\item \textbf{PR \#44 is verifiable:} The 47 $\to$ 1 DOF reduction can be confirmed by inspecting the public pull request. Links and diffs are included below.
...
Below we include the full before/after code excerpts, measurement tables, and links to the public PR and repository snapshots used for verification.
