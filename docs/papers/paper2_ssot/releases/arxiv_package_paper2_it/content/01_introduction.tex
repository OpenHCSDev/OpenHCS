...
Core theorems (capacity, realizability, complexity bounds) are machine-checked in Lean 4~\cite{demoura2021lean4} (9,369 lines, 441 theorems, 0 \texttt{sorry} placeholders). The entropy and mutual-information arguments in Section~\ref{sec:info-converse} apply standard information theory (Fano's inequality~\cite{cover2006elements}); we state these results without separate formalization, as they follow directly from the classical source.
