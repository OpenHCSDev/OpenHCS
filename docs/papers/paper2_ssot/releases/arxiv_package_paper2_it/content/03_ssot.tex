...
\end{proof}
See the formal Zero-Incoherence Capacity statement in Section~\ref{sec:capacity} (Theorem~\ref{thm:coherence-capacity}). A concise proof sketch appears below; the full mechanized proof is provided in Supplement~A.
