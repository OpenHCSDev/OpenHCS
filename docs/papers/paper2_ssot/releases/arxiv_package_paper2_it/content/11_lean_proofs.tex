...
\begin{itemize}
\item The abstract predicates correspond to actual encoding system features (instantiated by the corollary in Section~\ref{sec:evaluation})
\item The derivation relation correctly captures automatic propagation (illustrated by concrete examples in Section~\ref{sec:empirical})
\end{itemize}
